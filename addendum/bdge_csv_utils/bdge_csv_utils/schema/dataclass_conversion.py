import dataclasses
from dataclasses import make_dataclass, is_dataclass, fields as dc_fields, Field as DataclassField, MISSING
...
def dataclass_to_schema(cls: type) -> Schema:
    ...
    for dc_field in dc_fields(cls):
        ...
        schema_fields.append(Field(dc_field.name, field_type))
...
def instance_to_schema(instance: Any) -> Schema:
    ...
    for dc_field in dc_fields(instance):
        ...
        schema_fields.append(Field(dc_field.name, inferred_type))
