...
docker run --rm -d -t --dns 127.0.0.1 -p 60010:60010 -p 50070:50070 -p 9090:9090 -p 2022:22 -P -v /tmp:/root/tmp --name master.krejcmat.com -h master.krejcmat.com -w /root krejcmat/hadoop-hbase-master&> /dev/null
